...
class _CameraPageState extends State<CameraPage>
  ...
  /*
    initialize a new camera controller while overiting the previous one 
  */
  ...
  Widget actionBar(String? chatId) {
    return Align(
          ...
          GestureDetector(
            onTap: () async {
              ...
              if (pickedFile != null) {
                ...
                navigateToPrepSend(chatId, friendUid, friendName, 
                    '${directory.path}/$currentUnix.$fileFormat', pickedFile);
  ...
  Widget takePictureButton(String? chatId) {
    return InkWell(
      onTap: () async {
        ...
        debugPrint("Preparing to send image");

        navigateToPrepSend(
            chatId, friendUid, friendName, '${directory.path}/$currentUnix.$fileFormat', rawImage);
      },
      child: Stack(
        alignment: Alignment.center,
        children: const [
  ...
  void navigateToPrepSend(chatId, friendUid, friendName, imagePath, imageFile) {
    Get.toNamed(
      RouteHelper.getChatPrepSendPage(),
      arguments: {
        "chatId": chatId,
        "friendUid": friendUid,
