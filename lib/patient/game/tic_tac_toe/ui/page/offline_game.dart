...
import 'package:brain_training_app/patient/game/tic_tac_toe/ui/view_model/offline_game_controller.dart';
import 'package:brain_training_app/patient/game/tic_tac_toe/ui/view_model/settings_controller.dart';
import 'package:brain_training_app/patient/game/tic_tac_toe/ui/widget/board.dart';
import 'package:brain_training_app/patient/game/tic_tac_toe/ui/widget/represent_letter.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<GameController>(
            init: GameController(
                mode: mode, playerOne: playerLetter, stupidAi: stupidAi),
            builder: (controller) {
