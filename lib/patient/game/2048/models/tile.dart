...
class Tile {
  ...
  double? getNextTop(double size, int gridSize) {
  ...
  //Calculate the next top position based on the next index
  double? getNextLeft(double size, int gridSize) {
    if (nextIndex == null) return null;
    var i = (nextIndex! -
